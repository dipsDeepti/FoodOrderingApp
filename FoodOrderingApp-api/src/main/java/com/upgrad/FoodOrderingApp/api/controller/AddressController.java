...
public class AddressController {
    ...
    /* The method handles  save Address Related request.It takes the details as per in the SaveAddressRequest
     & generate response in SaveAddressResponse and returns UUID of newly Created Customer Address and Success message else Return error code and error Message.
      */
    @CrossOrigin
   ...
   */
    ...
    /*  The method handles States request.It generates response in StatesListResponse and returns UUID & stateName .If error Return error code and error Message.
     */
    @CrossOrigin
    ...
    public ResponseEntity<StatesListResponse> getAllStates(){
        ...
        if(!stateEntities.isEmpty()) {//check if StateEntities is empty.
